...
(function(window) {
	...
	GridFx.prototype._openItem = function(ev, item) {
		...
		this._setOriginal(item.querySelector('a').getAttribute('href'), images);
	...
	GridFx.prototype._setOriginal = function(src, images) {
		...
		// if (images) {
		// 	this.originalImg = images;
		// 	console.log('images',images);
		// 	for (var li in images) {
	 // 			//create here ul li
		// 	this.originalImg.className = 'original';
		// 	this.originalImg.style.opacity = 0;
		// 	this.originalImg.style.maxWidth = 'calc(' + parseInt(Math.abs(this.options.imgPosition.x)*100) + 'vw - ' + this.options.pagemargin + 'px)';
